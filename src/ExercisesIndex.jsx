      ...
      <div className="justify-center grid grid-cols-1 bg-zinc-900 shadow-2xl gap-5 p-3 align-center">
        {props.exercises.map((exercise) => (
          <div key={exercise.id} className="grid grid-cols-2">
            <div>
              <img className="m-auto max-w-m aspect-square object-cover" src={exercise.image_url} />
            </div>
            <div>
              ...
              <div className="p-5 space-x-10">
                ...
                <button className="bg-rose-500 p-2 gap-1 rounded hover:rounded-full">Quick Add</button>
              </div>
            </div>
          </div>
        ))}
